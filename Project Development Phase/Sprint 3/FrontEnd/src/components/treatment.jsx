...
const Treatment = () => (
  <div>
    <Header />
  <div class="ihd__features section__padding" id="features">
    <div class="ihd__features-heading">
      <h1 class="gradient__text">Here are some treatment options for heart diseases.</h1>
